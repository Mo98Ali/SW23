            ...
            if decision == "List":
             try:
                ...
                if  doc == "PSQI":
                     ...
                     flash("Name: "+db.PSQI.find_one({"username":name_patient})["username"])
                     flash("Surename "+db.PSQI.find_one({"username":name_patient})["Surename"])
                     flash("Age "+db.PSQI.find_one({"username":name_patient})["Age"])
                     flash("Weight[kg] "+db.PSQI.find_one({"username":name_patient})["Weight"])
                     flash("Gender "+db.PSQI.find_one({"username":name_patient})["Gender"])
                     flash("WorkingSituation "+db.PSQI.find_one({"username":name_patient})["WorkingSiuation"])
                     flash("BedTime4Weeks "+db.PSQI.find_one({"username":name_patient})["BedTime4Weeks"])
                     flash("Time2Sleep[HH:MM] "+db.PSQI.find_one({"username":name_patient})["Time2Sleep[HH:MM]"])
                     flash("RiseTime4Weeks[HH:MM] "+db.PSQI.find_one({"username":name_patient})["RiseTime4Weeks"])
                     flash("EffecSleeptime4Weeks[HH:MM] "+db.PSQI.find_one({"username":name_patient})["EffecSleeptime4Weeks[HH:MM]"])
                     flash("a_30toSleep "+db.PSQI.find_one({"username":name_patient})["a_30toSleep"])
                     flash("b_wakeups "+str(db.PSQI.find_one({"username":name_patient})["b_wakeups"]))
                     flash("c_Toilet: "+str(db.PSQI.find_one({"username":name_patient})["c_Toilet"]))
                     flash("d_BreathingProblems "+str(db.PSQI.find_one({"username":name_patient})["d_BreathingProblems"]))
                     flash("e_CoughSnore "+str(db.PSQI.find_one({"username":name_patient})["e_CoughSnore"]))
                     flash("f_toCold "+str(db.PSQI.find_one({"username":name_patient})["f_cold"]))
                     flash("g_toWarm "+str(db.PSQI.find_one({"username":name_patient})["g_toWarm"]))
                     flash("h_BadDreams "+str(db.PSQI.find_one({"username":name_patient})["h_BadDreams"]))
                     flash("i_Pain "+str(db.PSQI.find_one({"username":name_patient})["i_Pain"]))
                     flash("j_OtherFreq "+str(db.PSQI.find_one({"username":name_patient})["j_OtherFreq"]))
                     flash("j_OtherReasons "+str(db.PSQI.find_one({"username":name_patient})["OtherReasons"]))
                     flash("SleepQuality4Weeks "+str(db.PSQI.find_one({"username":name_patient})["SleepQulity4Weeks"]))
                     flash("Drugs "+str(db.PSQI.find_one({"username":name_patient})["Drugs"]))
                     flash("StayAwake "+str(db.PSQI.find_one({"username":name_patient})["Stayawake"]))
                     flash("NotEnoughEnergy "+str(db.PSQI.find_one({"username":name_patient})["NotEnoughEnergy"]))
                     flash("SleepAlone "+db.PSQI.find_one({"username":name_patient})["SleepAlone"])
                     flash("a_LoudSnoring "+str(db.PSQI.find_one({"username":name_patient})["a_LoudSnoring"]))
                     flash("b_StopBreathing "+str(db.PSQI.find_one({"username":name_patient})["b_StopBreathing"]))
                     flash("c_LegMoving "+str(db.PSQI.find_one({"username":name_patient})["c_LegMoving"]))
                     flash("d_ConfusionPeriodsAtNight "+str(db.PSQI.find_one({"username":name_patient})["d_ConfusionPeriodsAtNight"]))
                     flash("e_OtherFormsOfRestlessness "+str(db.PSQI.find_one({"username":name_patient})["e_OtherFormsOfRestlessness"]))
                     flash("PSQI evaluation:  "+str(db.PSQI.find_one({"username":name_patient})["Result"]))
                     Algo.csvExport(db.PSQI.find_one({"username":name_patient}))
                     Algo.excelExport(db.PSQI.find_one({"username":name_patient}))
...
def sleep_r():
    if request.method == "POST":
        ...
        if db.SleepDiary_m.count_documents({"user":username_g}) == 0:
            flash("No Morning SleepDiary available!")
            return redirect("/sleep_restriction")
